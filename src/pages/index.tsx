    ...
    <>
      ...
      <main className=" flex min-h-screen flex-col items-center justify-center">
        <div className="container flex flex-col items-center justify-center gap-8 px-4 py-24 text-justify ">
          ...
          наполняется совсем другими созданиями... Созданиями, для которых люди
          - всего лишь пища.
          <br />
          <br />
          ...
          которых скрываются вещи, недоступные нашему взору. Существа, живущие в
          тени, сокрыты от нас. Они смотрят на нас и видят добычу в наших телах
          и душах. Мы привыкли считать это ложью… Но наши опасения не надуманны.
          Они реальны.
          <br />
          <br />
          В своих убежищах просыпаются вампиры и выходят на тёмные улицы
          городов, терзаемые жаждой крови. За городом и в парках слышится
          ужасающий вой оборотней. А в темноте — тихий шелест пробуждающегося
          зла. Весь мир всего лишь полигон, на котором ведутся бесчисленные бои.
          <br />
          <br />
