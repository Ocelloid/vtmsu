  ...
  return (
    <div className="flex flex-col justify-between gap-16 md:flex-row md:items-center">
      ...
      <div className="flex flex-col gap-4 md:w-2/4">
        <div>
          <h1 className="text-3xl font-bold text-default dark:text-red-100">
            {product.title}
          </h1>
        ...
        <p className="text-default dark:text-red-100">{product.description}</p>
        <h6 className="flex flex-row text-2xl font-semibold text-default dark:text-red-100">
        ...
        <div className="flex flex-row items-center gap-2 md:gap-12">
          ...
          <Button
            ...
            className="h-full rounded-lg border-1 border-red-800 bg-transparent px-16 py-3 text-2xl font-semibold text-default dark:text-red-100"
          >
            Добавить
          </Button>
        </div>
